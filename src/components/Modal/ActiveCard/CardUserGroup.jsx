...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
   ...
   * Vì thế dựa vào mång board.FE_allUsers card.memberIds rồi chúng ta tạo ra một mång FE_CardMembers chứa đu thông tin của User để hien thị ra ngoài giao diện, bởi mặc định trong
    card chỉ lưu đám Id của User thôi (memberIds)
   */
  ...
  const handleUpdateCardMembers = (user) => {
    ...
    // Tao mot bien incomingMemberInfo đe gửi cho BE, voi 2 thông tin chinh là userId và action là xóa khỏi REMOVE card hoặc thêm ADD vào card
