...
function InviteBoardUser({ boardId }) {
  ...
  */
  ...
  const submitInviteUserToBoard = (data) => {
    ...
    // Gọi api mời 1 người dùng làm thành viên người dùng board
    inviteUserToBoardAPI({ inviteeEmail, boardId }).then((invitation) => {
      // Clear thẻ input sử dụng react-hook-form bằng setValue, đóng popover lại
      setValue('inviteeEmail', null)
      setAnchorPopoverElement(null)

      // Mời một người dùng vào board xong thì cũng sẽ gửi/emit sự kiện socket lên server (tính năng
      //real - time) => FE_USER_INVITED_TO_BOARD'
