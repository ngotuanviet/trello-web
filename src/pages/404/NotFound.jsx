    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          ...
          &nbsp;<Typography variant="span" sx={{ color: '#fdba26', fontWeight: 500 }}>TuanVietDev</Typography>?<br />Hmm, looks like that page doesn&apos;t exist.
        </Typography>
        <Box sx={{ width: '390px', height: '390px', position: 'relative' }}>
          ...
          <SvgIcon component={PlanetSvg} inheritViewBox sx={{ fontSize: 100 }} />
